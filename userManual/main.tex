...
In the \mintinline{bash}{examples/python/} folder, you can find two more Python
examples:
...
To regenerate all figures, evaluate \texttt{Figures.wls} located in \texttt{C/examples/mathematica}. On a standard 12-core laptop, the evaluation completes in under 2 minutes.
