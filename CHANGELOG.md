...
- `epsteinZetaAniso` erroneously unconditionally returned zero when some component of $\boldsymbol{\alpha}$ was odd and the same component of $\boldsymbol{x},\boldsymbol{y}$ vanished.
