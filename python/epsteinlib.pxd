...
cdef extern from "../include/epsteinZeta.h":
    ...
    double complex epsteinZetaAniso(double nu, int dim, const double *a, const double *x, const double *y, const unsigned int *alpha)
    double complex epsteinZetaAnisoReg(double nu, int dim, const double *a, const double *x, const double *y, const unsigned int *alpha)
